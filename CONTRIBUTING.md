...
In your browser, navigate to: [https://github.com/okta/okta-java-parent](https://github.com/okta/okta-java-parent)
...
``` bash
$ git clone https://github.com/YOUR_ACCOUNT/okta-java-parent.git
$ cd okta-java-parent
$ git remote add upstream https://github.com/okta/okta-java-parent.git
$ git checkout master
$ git fetch upstream
...
1. In your browser, navigate to your forked repository: [https://github.com/YOUR_ACCOUNT/okta-java-parent](https://github.com/YOUR_ACCOUNT/okta-java-parent)
